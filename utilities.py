...
lat_longs, us_lat_longs = format_lat_longs(countries)
date_retweets_dict = get_dates_and_retweets()

retweets_by_country_dict = get_retweets_by_country(
    lat_longs, date_retweets_dict, countries)

plot_locations(lat_longs, plot_us=False, date_retweets_dict=date_retweets_dict,
               save_every=100, batch_size=100, color_gradient=False)


generate_gif("images/global/")
"""
